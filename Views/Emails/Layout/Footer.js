...
const Footer = () => {
    return (
        `<div style="text-align: center; margin: 30px 0;">
                        <a href="https://www.food.arkshgroup.com/account"
                            style="display: inline-block; background: linear-gradient(135deg, #0055a4 0%, #29abe2 100%); color: #ffffff !important; text-decoration: none; padding: 14px 30px; font-weight: 600; font-size: 16px; border-radius: 30px; box-shadow: 0 4px 10px rgba(0, 85, 164, 0.3);">Track
                            Your Order</a>
                    </div>
                    ...
                    <div
                        ...
                        <p
                            style="color: #0055a4; font-size: 14px; font-weight: 600; margin: 10px 0; margin: 10px 0; padding: 0; line-height: 1.6;">
            ...
            <tr>
                <td align="center"
                    ...
                    <div style="margin: 20px 0;">
                        <a href="#"
                            style="color: #ffffff; text-decoration: none; margin: 0 10px; font-size: 14px;">Privacy
                            Policy</a>
                        <a href="#"
                            style="color: #ffffff; text-decoration: none; margin: 0 10px; font-size: 14px;">Terms of
                            Service</a>
                        <a href="#"
                            style="color: #ffffff; text-decoration: none; margin: 0 10px; font-size: 14px;">Return
                            Policy</a>
                    </div>

                    <p
                        style="font-size: 12px; color: rgba(255, 255, 255, 0.8); margin-top: 20px; margin: 20px 0 0 0; padding: 0; line-height: 1.6;">
                        &copy; ${new Date().getFullYear()} ARKSH Group. All rights reserved.</p>
                </td>
            </tr>
   `
    )
