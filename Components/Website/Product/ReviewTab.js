      ...
      <Card className="border-none">
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              className="w-full sm:w-auto bg-[#0055b8] hover:bg-[#0055b8]/90 text-white"
              onClick={async () => await AddReview(Product._id)}
            >
              Submit Review
            </Button>
          </div>
                ...
                <div key={index} className="flex items-start gap-4 mt-4">
                  <Avatar className="w-12 h-12 grid place-content-center">
                    <Avatar className="grid place-content-center">
                      {" "}
                      {Review?.User?.Name.split(" ")
                        .map((part, i) => (i === 0 || i === 1 ? part[0] : ""))
                        .join("")}
                    </Avatar>
                  </Avatar>
