...
import { Bold, Italic, UnderlineIcon, Link2, ImageIcon, Palette, List, ListOrdered, Quote, Minus, X, Undo, Redo, AlignLeft, AlignCenter, AlignRight, Code, Strikethrough, SubscriptIcon, SuperscriptIcon, Table2 } from "lucide-react"
import { useIngredientsTipTap } from "../Context/IngredientsTipTapContext";
const EditorTwo = () => {
    const { activeTab, setActiveTab, fontSize, setFontSize, textColor, setTextColor, highlightColor, setHighlightColor, imageSize, setImageSize, image, setImage, editor, tabs, handleImageUpload, insertImage, wordCount, setHeading, setTextColorForSelection, setHighlightColorForSelection, insertTable } = useIngredientsTipTap();
    return (
        <div className="w-full mx-auto bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-xl overflow-hidden transition-colors duration-200">
