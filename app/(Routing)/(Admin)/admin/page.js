...
import { Package, ShoppingCart, Users, DollarSign, ChevronRight, RefreshCw, FileSpreadsheet, Download, TrendingUp } from "lucide-react";
import { ExportUserDetails } from "@/utils/Reports/UserReport";
...
const AdminDashboard = () => {
  ...
  const [Stats, setStats] = useState([
    {
      ...
      value: 0,
      bgPattern:
        "radial-gradient(circle at 90% 10%, #0057b7/10%, transparent 60%)",
    },
    {
      key: "TotalOrders",
      title: "Orders",
  ...
  const generateExcelReport = async (reportType) => {
    try {
      ...
      const users = [
        { name: "Papu", email: "papu@example.com", role: "admin" },
        { name: "Ram", email: "ram@example.com", role: "user" },
      ];
      ExportUserDetails(users);
