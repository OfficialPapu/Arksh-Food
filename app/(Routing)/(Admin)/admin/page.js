      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="mt-6 space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="border-none shadow-sm hover:shadow transition-shadow duration-200">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Zap className="h-5 w-5 text-[#39b9ef]" />
                  Quick Actions
                </CardTitle>
              </CardHeader>
              <CardContent className="grid gap-3">
                <Button asChild className="justify-start bg-[#0057b7] hover:bg-[#0055a4]/90">
            ...
            {/* Sales overview */}
            <Card className="border-none shadow-sm hover:shadow transition-shadow duration-200 md:col-span-3">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="gap-1 border-blue-200 bg-blue-50 text-[#0057b7]">
              ...
              <CardContent>
                <div className="h-[240px] w-full rounded-lg border bg-gray-50 p-6">
                  <div className="flex h-full flex-col items-center justify-center gap-2 text-gray-500">
                    <BarChart3 className="h-10 w-10 text-[#39b9ef]" />
                    <p className="text-center font-medium">Sales chart will appear here</p>
                    <p className="text-center text-xs">Connect your data source to see real-time analytics</p>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="border-t bg-gray-50 px-6 py-3">
